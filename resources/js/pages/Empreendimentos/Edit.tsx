...
const breadcrumbs = (empreendimento: Props['empreendimento']): BreadcrumbItem[] => [
    ...
    },
    {
        ...
        href: empreendimentos.show.url(empreendimento.id),
    },
    {
        title: 'Editar',
        href: empreendimentos.edit.url(empreendimento.id),
    },
];

export default function Edit({ empreendimento }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        ativo: empreendimento.ativo ?? true,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(empreendimentos.update.url(empreendimento.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs(empreendimento)}>
            <Head title={`Editar ${empreendimento.nome}`} />
